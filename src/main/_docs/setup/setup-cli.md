...
|----------|-------------|
| `{{site.data.env["HOST"]}}` | The IP address or DNS name of the Che service. We use `eclipse/che-ip` to attempt discovery if not set. |
